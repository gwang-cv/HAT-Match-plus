...
net_arg.add_argument(
    ...
    "cluster number in HAT-Match. Default: 250")
net_arg.add_argument(
...
net_arg.add_argument(
    "--use_fourier", type=str2bool, default=False, help=""
    "use high-frequency fourier positional encodings for coordinates. Default: False")
net_arg.add_argument(
    "--sr", type=float, default=0.5, help=""
    "sampling rate. Default: 0.5")
net_arg.add_argument(
    "--k_num", type=int, default=9, help=""
    "number of nearest neighbors for graph construction. Default: 9")
net_arg.add_argument(
    "--ablate_depth", type=int, default=0, help=""
    "controls layer-by-layer peeling ablation. 0: full, 1: w/o CSCA, 2: w/o CSCA & VCA, 3: w/o CSCA, VCA & MCA, 4: w/o CSCA, VCA, MCA & SA+, 5: w/o all (+MGA)")

# -----------------------------------------------------------------------------
# Data
data_arg = add_argument_group("Data")
data_arg.add_argument(
    "--data_tr", type=str, default=r'../data_dump/yfcc-sift-2000-train.hdf5', help=""
    "name of the dataset for train")
data_arg.add_argument(
    "--data_va", type=str, default=r'../data_dump/yfcc-sift-2000-val.hdf5', help=""
    "name of the dataset for valid")
data_arg.add_argument(
    "--data_te", type=str, default=r'../data_dump/yfcc-sift-2000-test.hdf5', help=""
...
loss_arg.add_argument(
    "--loss_type", type=str, default="bce", choices=["bce", "focal"], help=""
...
train_arg.add_argument(
    ...
    "batch size")
train_arg.add_argument(
    "--accum_steps", type=int, default=1, help=""
    "gradient accumulation steps. effective batch = train_batch_size * accum_steps")
train_arg.add_argument(
